...
<img src="Icons/icon.ico" alt="Secure Pass Pro" width="96">
...
[![Version](https://img.shields.io/badge/Version-4.0.1-6366f1?style=flat-square)]()
...
<div align="center">
  <img src="Secure_Pass_MainWindow40.jpg" alt="Secure Pass Pro v4.0 — Главное окно" width="780">
  <br>
...
<div align="center">
  <img src="Secure_Pass_MainWindow41.jpg" alt="Secure Pass Pro v4.0 — Индикация надёжности" width="780">
  <br>
...
Скачайте [`SecurePassPro.exe`](../../releases/latest) из раздела Releases и запустите — установка не требуется.

### 🐍 Запуск из исходников

```bash
# 1. Клонировать репозиторий
git clone https://github.com/yourusername/secure-pass-pro.git
cd secure-pass-pro
