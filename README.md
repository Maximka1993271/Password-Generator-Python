...
| 🌈 **RGB анимация** | Динамическая цветная анимация **границ окна** и **заголовка Windows 11** (4 независимые полосы). Кнопки "Закрыть/Свернуть/Развернуть" НЕ анимируются |
...
| Раздел | Что добавлено/исправлено |
|--------|--------------------------|
| **Основные возможности** | Добавлена строка `💾 Автосохранение` |
| **Ключевые особенности v4.0** | Добавлены "Модульная архитектура", "Автосохранение" |
| **Сравнение версий** | Добавлены "Автосохранение", "Модульная архитектура" |
| **Уникальные преимущества v4.0** | НОВЫЙ раздел! Опиcаны автосохранение, RGB, модульность, локализация, Argon2id |
| **RGB анимация** | Уточнено: границы окна + заголовок Windows 11, системные кнопки НЕ анимируются |

---

**Всё готово для обновления `README.md` на GitHub!** 🚀
