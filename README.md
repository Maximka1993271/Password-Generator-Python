...
| Функция | Описание |
|---------|----------|
| 🎬 **Анимация кнопок** | Живой отклик — текст кнопок мгновенно сжимается при нажатии, обеспечивая четкую визуальную обратную связь |
...
- **Неоновые чекбоксы** — подсветка при наведении и вспышка при клике
...
- **Неоновые чекбоксы** — подсветка при наведении и вспышка при клике
- **Цветовая индикация** — зелёный (включено) / красный (выключено) для всех переключателей
...
Secure Pass Pro v4.0 — профессиональный генератор паролей с открытым исходным кодом 🔐
...
| Раздел | Добавлено |
|--------|-----------|
| **Новое в версии 4.0.9** | Увеличены размеры окон, цветовая индикация кнопок, неоновые чекбоксы |
| **Цветовая схема кнопок меню** | ✅ НОВЫЙ раздел с таблицей цветов |
| **Цветовая индикация переключателей** | ✅ НОВЫЙ раздел (зелёный/красный для всех переключателей) |
| **Сравнение версий** | Добавлены строки "Неоновые чекбоксы" и "Цветовая индикация кнопок" |
| **Уникальные преимущества** | Добавлены "Неоновые чекбоксы" и "Цветовая индикация" |
